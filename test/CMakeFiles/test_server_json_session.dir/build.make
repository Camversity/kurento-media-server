...
kurento-media-server/test/CMakeFiles/test_server_json_session.dir/server_json_session.cpp.o: kurento-media-server/test/server_json_session.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/vbccam/kms-omni-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object kurento-media-server/test/CMakeFiles/test_server_json_session.dir/server_json_session.cpp.o"
	cd /home/vbccam/kms-omni-build/kurento-media-server/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test_server_json_session.dir/server_json_session.cpp.o -c /home/vbccam/kms-omni-build/kurento-media-server/test/server_json_session.cpp
...
kurento-media-server/test/CMakeFiles/test_server_json_session.dir/server_json_session.cpp.i: cmake_force
	...
	cd /home/vbccam/kms-omni-build/kurento-media-server/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/vbccam/kms-omni-build/kurento-media-server/test/server_json_session.cpp > CMakeFiles/test_server_json_session.dir/server_json_session.cpp.i
...
kurento-media-server/test/CMakeFiles/test_server_json_session.dir/server_json_session.cpp.s: cmake_force
	...
	cd /home/vbccam/kms-omni-build/kurento-media-server/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/vbccam/kms-omni-build/kurento-media-server/test/server_json_session.cpp -o CMakeFiles/test_server_json_session.dir/server_json_session.cpp.s
...
kurento-media-server/test/test_server_json_session: kms-core/src/server/libkmscoreimpl.so.7.0.0~12.g215c44de
...
kurento-media-server/test/test_server_json_session: kms-core/src/gst-plugins/commons/libkmsgstcommons.so.7.0.0~12.g215c44de
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_filesystem.so
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_system.so
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_unit_test_framework.so
kurento-media-server/test/test_server_json_session: kurento-media-server/test/libbase_test.a
kurento-media-server/test/test_server_json_session: kms-core/src/gst-plugins/commons/sdpagent/libkmssdpagent.so.7.0.0~12.g215c44de
...
kurento-media-server/test/test_server_json_session: kms-jsonrpc/src/libjsonrpc.so.7.0.0~5.g791061f
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_filesystem.so
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_system.so
kurento-media-server/test/test_server_json_session: /usr/lib/x86_64-linux-gnu/libboost_unit_test_framework.so
...
kurento-media-server/test/test_server_json_session: kurento-media-server/test/CMakeFiles/test_server_json_session.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/vbccam/kms-omni-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test_server_json_session"
	cd /home/vbccam/kms-omni-build/kurento-media-server/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test_server_json_session.dir/link.txt --verbose=$(VERBOSE)
...
kurento-media-server/test/CMakeFiles/test_server_json_session.dir/clean:
	cd /home/vbccam/kms-omni-build/kurento-media-server/test && $(CMAKE_COMMAND) -P CMakeFiles/test_server_json_session.dir/cmake_clean.cmake
